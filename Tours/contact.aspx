...
<body>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.aspx">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="contact.html"> Contact Us</a>s</p>
						</div>	
					</div>
				</div>
			</section>
							...
							<form runat="server">
								<div class="row">	
									<div class="col-lg-6 form-group">
										<asp:TextBox  id="name" runat="server" placeholder="Enter your name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" class="common-input mb-20 form-control"></asp:TextBox>
									
										<asp:TextBox   name="email" id="email" runat="server" placeholder="Enter email address" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" class="common-input mb-20 form-control" required="" type="email"></asp:TextBox>

										<asp:TextBox   name="subject" id="subject" runat="server" placeholder="Enter subject" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter subject'" class="common-input mb-20 form-control" required="" type="text"></asp:TextBox>
									</div>
									<div class="col-lg-6 form-group">
										<asp:TextBox   id="message" class="common-textarea form-control" name="message" 
                                            placeholder="Enter Messege" onfocus="this.placeholder = ''" 
                                            onblur="this.placeholder = 'Enter Messege'" required="" runat="server" 
    ...
    <asp:Button ID="btna" runat="server"  Text="Submit" OnClick="btna_Click" />
